          ...
          <div className="text-left">
            <div className="flex items-center mb-6">
              <div className="bg-amber-500/20 backdrop-blur-sm border border-amber-400/30 rounded-full px-4 py-2 flex items-center">
                ...
                <span className="text-sm font-medium text-amber-100">Premium Real Estate</span>
              </div>
            </div>

            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold mb-6 leading-tight">
              Discover Your
              <span className="block text-amber-300 font-serif italic">Dream Paradise</span>
            ...
            <div className="bg-amber-500/20 backdrop-blur-sm border border-amber-400/30 rounded-lg p-6 mb-8">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-amber-200 mb-1">Starting Investment</p>
                  <p className="text-3xl font-bold text-amber-300">₹35 Lacs*</p>
                </div>
                <div className="text-right">
                  <p className="text-sm text-amber-200 mb-1">Pre-Launch Offer</p>
                  <p className="text-lg font-semibold text-white">Limited Time</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              ...
              <InquiryPopup>
                <Button
                  size="lg"
                  variant="outline"
                  className="border-2 border-amber-300 text-amber-300 hover:bg-amber-300 hover:text-amber-900 bg-transparent font-semibold px-8 py-4 text-lg"
                >
          ...
          <div className="lg:block hidden">
            <div className="grid grid-cols-1 gap-6">
              <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-xl p-6 text-center">
                <h3 className="text-3xl font-bold text-amber-300 mb-2">₹35L+</h3>
                <p className="text-amber-100 font-medium">Starting Price</p>
                <p className="text-sm text-amber-200 mt-1">Pre-launch exclusive</p>
              </div>

              <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-xl p-6 text-center">
                <h3 className="text-3xl font-bold text-amber-300 mb-2">Prime</h3>
                <p className="text-amber-100 font-medium">Location</p>
                <p className="text-sm text-amber-200 mt-1">High growth potential</p>
              </div>

              <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-xl p-6 text-center">
                <h3 className="text-3xl font-bold text-amber-300 mb-2">100%</h3>
                <p className="text-amber-100 font-medium">Transparency</p>
                <p className="text-sm text-amber-200 mt-1">Direct developer sales</p>
              </div>
            </div>
          </div>
        </div>
